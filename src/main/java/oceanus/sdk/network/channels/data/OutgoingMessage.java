            ...
            if (encode != null) {
                switch (encode) {
                    case BinaryCodec.getENCODE_PB():
                        try {
                            OutgoingMessage request = MessagePB.OutgoingMessage.invokeMethod("parseFrom", new Object[]{bytes});
                            ...
                            if (request.invokeMethod("hasField", new Object[]{MessagePB.OutgoingData.invokeMethod("getDescriptor", new Object[0]).invokeMethod("findFieldByName", new Object[]{"fromUserId"})}).asBoolean())
                                fromUserId = ((String) (request.invokeMethod("getFromUserId", new Object[0])));
                            if (request.invokeMethod("hasField", new Object[]{MessagePB.OutgoingData.invokeMethod("getDescriptor", new Object[0]).invokeMethod("findFieldByName", new Object[]{"fromGroupId"})}).asBoolean())
                                fromGroupId = ((String) (request.invokeMethod("getFromGroupId", new Object[0])));
